...
import Gpt2StackInline from '../../components/blog/Gpt2StackInline.astro';
import SelfAttentionInline from '../../components/blog/SelfAttentionInline.astro';
...
This diagram is **hand-authored SVG** (not a Mermaid export) so it stays sharp on retina displays and matches the rest of the site. It is **inlined in the page** so it renders the same in every browser (no separate image request).
